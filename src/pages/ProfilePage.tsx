    ...
    <div className="space-y-4">
      ...
      >
        ...
        {!user.subscriptionActive && (
          <button
            ...
            className="mt-3 flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-yellow-600/80 to-yellow-500/80 text-white text-sm font-semibold hover:from-yellow-500 hover:to-yellow-400 transition-all shadow-lg shadow-yellow-500/20"
          >
            <Star size={14} />
            Купить подписку — 5 кбк/мес
          </button>
        )}
      </motion.div>
      ...
      >
        ...
        <div className="space-y-3">
          {/* Telegram — перенесён сюда из шапки */}
            ...
            >
              ...
              <div className="glass-card-static p-4 mb-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-lg font-bold text-yellow-400">5 кбк / месяц</span>
                </div>
                <div className="flex items-center justify-between">
              ...
              <div className="glass-card-static p-4 mb-4 space-y-2">
                ...
                <ol className="text-sm text-dark-300 space-y-1.5 list-decimal list-inside">
                  ...
                  <li>Переведите <span className="text-yellow-400 font-semibold">5 кбк</span> на счёт <span className="text-red-400 font-semibold">kbpost</span></li>
